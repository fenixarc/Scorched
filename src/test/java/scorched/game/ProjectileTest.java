...
class ProjectileTest {
    ...
    void setUp() {
        ...
        // Default stubbing for AmmoType to prevent NullPointerExceptions and support initial tests
        when(mockAmmoType.getRadius()).thenReturn(5);
        when(mockAmmoType.getExplosionRadius()).thenReturn(40);
        when(mockAmmoType.getDamage()).thenReturn(60);
    ...
    void testInitializationAndGetters() {
        // Fire at 45 degrees, power 10, passing the mockAmmoType
        Projectile projectile = new Projectile(100, 200, 45, 10.0, mockAmmoType);
    ...
    void testUpdateMovesProjectileAndAppliesGravity() {
        ...
        Projectile projectile = new Projectile(100, 200, 0, 10.0, mockAmmoType);
    ...
    void testOffScreenDeactivatesProjectile() {
        ...
        Projectile projectile = new Projectile(795, 200, 0, 10.0, mockAmmoType);
    ...
    void testSkyCheckDoesNotDeactivate() {
        ...
        Projectile projectile = new Projectile(100, 5, 90, 10.0, mockAmmoType);
    ...
    void testTerrainCollision() {
        ...
        Projectile projectile = new Projectile(100, 295, 0, 10.0, mockAmmoType);
